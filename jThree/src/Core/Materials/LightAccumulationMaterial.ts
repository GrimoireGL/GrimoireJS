...
class LightaccumulationMaterial extends Material {
  ...
  configureMaterial(scene:Scene,renderer: RendererBase, object: SceneObject): void {
    ...
    programWrapper.registerTexture(renderer, this.rb1, 0, "rb1");
    programWrapper.registerTexture(renderer, this.rb2, 1, "rb2");
    programWrapper.registerTexture(renderer, this.depth, 2, "depth");
