...
class Canvas extends CanvasRegion implements ICanvasContainer {
  ...
  */
  ...
  protected __initializeAlternativeTexture(): TextureBase {
    let tex = <BufferTexture>ResourceManager.createTexture("jthree.alt.texture2D." + this.id, 1, 1);
  ...
  protected __initializeAlternativeCubeTexture(): CubeTexture {
    let tex = ResourceManager.createCubeTextureWithSource("jthree.alt.textureCube." + this.id, null);
    return tex;
  }
