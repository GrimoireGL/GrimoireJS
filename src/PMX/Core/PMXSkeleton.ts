...
class PMXSkeleton {
  ...
  constructor(model: PMXModel) {
    ...
    this._matrixTexture = <TextureBuffer>ResourceManager.createTexture("jthree.pmx.bonetransform" + model.id, 4, this._bones.length, WebGLRenderingContext.RGBA, WebGLRenderingContext.FLOAT);
  }
